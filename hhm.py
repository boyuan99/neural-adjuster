...
class HodgkinHuxley():
    ...
    def __init__(self, C_m=1, g_Na=120, g_K=36, g_L=0.3, E_Na=50, E_K=-77, E_L=-54.387, t_0=0, t_n=450, delta_t=0.01,
                 I_inj_max=0, I_inj_width=0, I_inj_trans=0, vc_delay=10, vc_duration=30, vc_condVoltage=-65,
        ...
        if __name__ == '__main__':
            ...
            if (num_args == 1 or sys.argv[1] == '-iclamp'):  # default mode
                ...
                self.t = np.arange(0, 50,
                                   0.0001)  # update default time array for python script (notebook can be controlled through widgets)
            else:
